import { View, Text, Alert, ScrollView, KeyboardAvoidingView, Platform, TextInput, TouchableOpacity } from 'react-native'
...
const SignUpScreen = () => {
  ...
  const handleSignUp = async () => {
    if(!email || !password) return Alert.alert("Error","Please fill in all fields")
        if(password.length < 6) return  Alert.alert("Error","password must be atleast of 6 characters")
            if(!isLoaded) return;
    setLoading(true)
    try {
